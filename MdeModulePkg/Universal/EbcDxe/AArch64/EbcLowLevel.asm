...
EbcLLCALLEXNative PROC
  ...
  //
  adr     x0, %F0                  // Take address of 'br' instruction below
...
//
//****************************************************************************
EbcLLExecuteEbcImageEntryPoint PROC
  mov     x2, x16
...
mEbcInstructionBufferTemplate PROC
  adr     x17, %F0
  ldp     x16, x17, [x17]
  br      x17
...
0:
  EBC_ENTRYPOINT_SIGNATURE          DCO   0x0
  EBC_LL_EBC_ENTRYPOINT_SIGNATURE   DCO   0x0
mEbcInstructionBufferTemplate ENDP
  END